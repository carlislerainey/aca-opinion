...
# load data
d <- read.spss("Data/Kaiser/kaiser_2013_02.por")
...
levels(education)[levels(education)=="Four year college or university degree/Bachelor"] <- "college graduate"
levels(education)[levels(education)=="Some postgraduate or professional schooling, no postgraduate degree"] <- "college graduate"
levels(education)[levels(education)=="Postgraduate or professional degree, including master"] <- "postgraduate"
...
# write csv file
write.csv(new.data, "Data/Cleaned_Poll_Data/kaiser_2013_02.csv", row.names = FALSE)
